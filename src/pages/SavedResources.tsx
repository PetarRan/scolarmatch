...
const mockSavedResources = [
  {
    ...
    source: "Reddit.com",
    description:
      "A comprehensive thread where recent college graduates share their post-college experiences, career paths, and advice for those about to enter the workforce. Covers various industries and personal stories.",
  ...
  },
  {
    ...
    description:
      "Hacker News discussion about the evolving path to becoming a software engineer, considering the impact of AI tools, changing industry requirements, and advice for career changers.",
  ...
  },
  {
    ...
    source: "medium.com",
    description:
      "Personal story of transitioning from a non-technical background to a software engineering role at a major tech company. Includes study strategies, interview preparation, and lessons learned.",
